...
process fctcon {
  ...
  publishDir "$params.outDir/combined/facets", overwrite: 'true', mode: 'copy', pattern: "{*.CNA.*,!${params.runID}*}"
  publishDir "$params.outDir/combined/facets/per_case", overwrite: 'true', mode: 'copy', pattern: "!{*.CNA.*,${params.runID}*}"
